...
int main()
{
	...
	while (true)
	{
		...
		cout << "당신이 뽑은카드 " << player_card.Getglyph() << " , " << player_card.Getnumber() << endl;
		cout << "컴퓨터가 뽑은카드 1 : " << com1_card.Getglyph() << " , " << com1_card.Getnumber() << endl;
		cout << "컴퓨터가 뽑은카드 2 : " << com2_card.Getglyph() << " , " << com2_card.Getnumber() << endl;
		cout << endl;
